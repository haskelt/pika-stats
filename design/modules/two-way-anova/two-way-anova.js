...
import descriptives from './descriptives.js?v={{project.version}}';
import graph from './graph.js?v={{project.version}}';
import anova from './anova.js?v={{project.version}}';
import verbal_description from './verbal-description.js?v={{project.version}}';
import controls from './controls.js?v={{project.version}}';
...
class DataManager {
	...
	controls.initialize(this.update.bind(this));
