...
import descriptives from '/js/descriptives/descriptives.js?v=0.4.0-alpha';
import graph from '/js/graph/graph.js?v=0.4.0-alpha';
import anova from '/js/anova/anova.js?v=0.4.0-alpha';
