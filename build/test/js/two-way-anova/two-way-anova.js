...
import descriptives from './descriptives.js?v=0.7.2-beta';
import graph from './graph.js?v=0.7.2-beta';
import anova from './anova.js?v=0.7.2-beta';
import verbal_description from './verbal-description.js?v=0.7.2-beta';
import controls from './controls.js?v=0.7.2-beta';
