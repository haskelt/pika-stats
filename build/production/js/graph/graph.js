...
import d3legends from '/pika-stats/js/d3/d3.legends.js?v=0.3.0-alpha';
...
class Graph {
	...
	this.y.domain([minY - .15 * range, maxY + .15 * range]);
...
//	    .range('d3.schemePaired);
	...
	this.svg.selectAll("line")
	    ...
	    .join("line")
	    .attr("x1", (d, i) => this.x(this.data.factors[0]['levels'][0]))
	    .attr("x2", (d, i) => this.x(this.data.factors[0]['levels'][1]))
